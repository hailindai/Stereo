...
import com.dreamguard.stereo.StereoApplication;
...
public class TxRequest {
    ...
    private static final Interceptor REWRITE_CACHE_CONTROL_INTERCEPTOR = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (NetWorkUtil.isNetWorkAvailable(StereoApplication.getContext())) {
    ...
    private static File httpCacheDirectory = new File(StereoApplication.getContext().getCacheDir(), "txCache");
